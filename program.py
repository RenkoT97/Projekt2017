...
seznam3 = pretvori_dat_v_sez('operacije.txt')

št_kenkena = random.randint(0, 9)

barve = {'A': 'chocolate3', 'B': 'green yellow', 'C': 'RoyalBlue3', 'D': 'maroon1', 'E': 'NavajoWhite2', 'F': 'lime green', 'G': 'DarkOrange1', 'H': 'Sienna1', 'I': 'DeepPink4', 'J': 'SkyBlue3', 'K': 'purple4', 'L': 'SeaGreen1', 'M': 'gold', 'N': 'red3', 'O': 'LightPink3'}
...
def preveri_rešitve():
    rešitve = print([[gumb1.get(), gumb2.get(), gumb3.get(), gumb4.get(), gumb5.get(), gumb6.get()], \
                    [gumb7.get(), gumb8.get(), gumb8.get(), gumb10.get, gumb11.get(), gumb12.get()], \
    ...
    if rešitve == seznam1:
        ...
        return 'Vaša rešitev je napačna.'
